...
/* otg fs2 device fifo 
   otg fs2 fifo size is 1280 byte
*/
#define USBD2_RX_SIZE                     128  /*this value is in terms of 4 bytes*/
#define USBD2_EP0_TX_SIZE                 24   /*this value is in terms of 4 bytes*/
#define USBD2_EP1_TX_SIZE                 20   /*this value is in terms of 4 bytes*/
...
/* otg2 host fifo 
   otg fs2 fifo size is 1280 byte
*/
#define USBH2_RX_FIFO_SIZE                128  /*this value is in terms of 4 bytes*/
#define USBH2_NP_TX_FIFO_SIZE             96   /*this value is in terms of 4 bytes*/
#define USBH2_P_TX_FIFO_SIZE              96   /*this value is in terms of 4 bytes*/
#endif
